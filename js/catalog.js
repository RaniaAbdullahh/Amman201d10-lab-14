...
function addSelectedItemToCart() {
    ...
    var sellectItem = document.getElementById('items');

      // TODO: get the quantity
    var qEl = document.getElementById('quantity');

    // TODO: using those, add one item to the Cart
    cart.addItem(sellectItem.value,qEl.value);
...
function updateCartPreview() {
  ...
  let quentetyEle = document.getElementById('quantity')
  // TODO: Add a new element to the cartContents div with that information
  let cartContents = document.getElementById('cartContents');
  cartContents.innerHTML += ` ${itemsEle.value} ${quentetyEle.value}<br>`
}
